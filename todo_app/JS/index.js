...
var todos = new Array;
/*This pulls the task that was saved in the web brouser memory*/
var todos_str = localStorage.getItem('todo');
/*If the input is not null then JSON.parse will communicate
with the web brouser to make the task a Javascript object.*/
if (todos_str!== null){
...
function show(){
    ...
    for (var i = 0; i <todos.length; i++) {
        ...
        html += '<li>' + todos [i] + '<button class="remove" id"' + i + '">x</butto> e "X"</li>'
...
/*This tells the brouser how to display the todo
